...
#### Phase 1m — simplifications of usage code for "literary" students ?

Looking at my AGD course at `/home/dev1/github/formations_stat/cours/M2S1/livre/`, can you think of further ways to simplify usage code and make it more readable and more easily usable by students (beginners in R programming, the kind of students that can to tabxplor::tab() code but struggle with anything more complex) ? Can you think of little quality-of-life improvements that would make it easier for them to use `ggfacto::` ? (Note that the code giving by the course is sometimes too convoluted, but that the next version of the course will mostly always use the same kind of code and steps in the course and in the exams, to acustom students to a unique data exploration workflow.)

Resolve old test failures.




#### Phase 1n — 0.4.0 release
