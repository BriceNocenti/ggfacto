---
title: "Introduction à ggfacto : ACP, AC et ACM au plus près des données"
description: >
  Les trois analyses géométriques de données en un seul geste : l'analyse, son tableau
  d'interprétation, son graphique interactif, puis les classes.
---
...
# La langue est fixée des deux côtés -- l'option pour les légendes, LANGUAGE pour gettext -- pour que
# la page ne dépende pas de la machine qui la construit.
options(tabxplor.lang = "fr")
Sys.setenv(LANGUAGE = "fr")
# Les tableaux sont les vrais tableaux html de tabxplor ; leur feuille de style est émise une fois,
# dans le chunk ci-dessous, et suit l'interrupteur clair/sombre du site.
...
*An English version of this guide is available: [Introduction to ggfacto](https://bricenocenti.github.io/ggfacto/articles/ggfacto.html).*
...
La [référence](https://bricenocenti.github.io/ggfacto/reference/index.html) détaille chaque fonction.
